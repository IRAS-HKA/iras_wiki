...
- [ ] In [IRAS-Team](https://teams.microsoft.com/l/team/19%3A993e12e777504fe780588b16052b3ae6%40thread.tacv2/conversations?groupId=0ef915a4-317e-4f97-bf5d-da88636a2912&tenantId=a31a26ed-e288-49e8-8a94-cf238ac22662) (und Projekt-Teams) aufgenommen werden (Teams Account muss eingerichtet sein)
- [ ] [Vertrauensarbeitszeit](https://www.h-ka.de/fileadmin/Hochschule_Karlsruhe_HKA/Bilder_VW-PE/Antrag_VAZ.pdf) beantragen
- [ ] [W-Plan](https://wplan.h-ka-w.de/wplan/) Account einrichten
- [ ] LAN-Zugang prüfen (in W1 Netz eintragen lassen → E-Mail an: yongzhou.zhang@h-ka.de)
- [ ] Profil im [Intranet](https://www.h-ka.de/intern) aktualisieren
- [ ] HKA-Vorlagen ([PowerPoint-Vorlagen HKA](https://www.h-ka.de/intern/mitarbeitende/organisieren/hochschulweite-prozesse/prozesse-corporate-design-corporate-identity#c48553), [Poster-Vorlagen IRAS](https://hskarlsruhede.sharepoint.com/:f:/s/RobolabLeitung2/IgASFDd8E67XRZiiLe8QLfvNAVbMUC2VVpUhZwBP-ZCSQGQ?e=lhj0Hl), [Logo IRAS](https://hskarlsruhede.sharepoint.com/:f:/s/RobolabLeitung2/IgBQ_S5gbuhNSpPMbRde_bAkAWghJI6F5ZW-Ioyuy9dI22E?e=QRDY39))
...
- [ ] Eintragen in Liste für Kaffeemaschinenreinigung → selbstständig im nächsten Town Hall Meeting ansprechen
- [ ] [RZ-Handout](rz.h-ka.de/RZ-Introduction-Handout.pdf):
  - [ ] [E-Mail-Zugang](https://rz.h-ka.de/RZ-Introduction-Handout.pdf#page=18.27) überprüfen (lokal über Outlook oder im Browser [vom Hochschulnetz aus](https://webmail.h-ka.de/) bzw. [von außerhalb des Hochschulnetzes](https://owa.h-ka.de/))
  - [ ] [E-Mail Zertifikat](https://rz.h-ka.de/RZ-Introduction-Handout.pdf#page=21.00) einrichten 
  - [ ] Zugang zu [SmartTime](https://ze01.hs-karlsruhe.de/SmartTime/) überprüfen
  - [ ] [VPN-Zugang](https://rz.h-ka.de/RZ-Introduction-Handout.pdf#page=36.09) einrichten ([Mehr-Faktor-Authentifizierung](https://rz.h-ka.de/RZ-Introduction-Handout.pdf#page=25.34))
  - [ ] W-LAN einrichten ([eduroam](https://rz.h-ka.de/RZ-Introduction-Handout.pdf#page=10.09))
  - [ ] Zoom Account beantragen (E-Mail an [Benutzerberatung](bb.rz@h-ka.de) versenden, um Prozess anzustoßen)
  - [ ] [bwSync&Share](https://rz.h-ka.de/RZ-Introduction-Handout.pdf#page=112.32)

### Für Doktoranden:
- [ ] [FRIDA](https://frida.h-ka.de/) Account 

### Optional für alle Mitarbeiter: 
- [ ] Schließfach am LTC → Kollegen ansprechen
- [ ] Account [Getränke-App](https://iqmeta.com/gliste)
- [ ] GitHub / GitLab Zugang überprüfen
- [ ] Beitritt IRAS/IRP-WhatsApp Gruppe → Kollegen ansprechen
