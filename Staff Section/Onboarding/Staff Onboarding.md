This document lists the most important links and information new colleques at the IRAS research group need to know about. Copyable email blocks are shown below. These only need to be adjusted at the colored sections by the appropriate salutation of the new colleque and copied together appropriately. At the corresponding points, additional procedural instructions are listed that the supervising person must complete **before** the mail is sent.
...
#### Tasks for the supervising person
- [ ] Add the new colleque with their student ID to the [HKA 2030+ Forum](https://ilias.h-ka.de/ilias.php?ref_id=596294&cmdClass=ilcoursemembershipgui&cmdNode=y0:mu:91&baseClass=ilRepositoryGUI)
- [ ] If the new colleque starts a thesis or project work on the Mauerroboter, there is a separate team for this purpose `Mauerroboter Abschlussarbeiten`. Add the student [here](https://teams.microsoft.com/_#/teamDashboard/Abschlussarbeiten%20MauerRoboter/19:4f376842cb524daebe5ac25c32cba6e7@thread.tacv2/td.members) 
...
- Somehow get internet access
- Check E-Mails
- Try to create an account for MS Teams
- Get access to GitHub / GitLab repositories containing the wiki
